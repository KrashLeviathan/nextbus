...
std::string predictions(const char *agency, const char *stopTag, const char *routeTag);

std::string predictionsForMultiStops(const char *agency, std::vector<std::string> stopTagVector);
