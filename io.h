...
# define ACTION_SCHEDULE_LIST 0x00000008  // -s --schedule
# define ACTION_HELP          0x00000010  // -h --help
# define ACTION_PREDICT_STOP  0x00000020  // -p --predictstop
# define ACTION_PREDICT_ROUTE 0x00000040  // -P --PredictRoute
# define ACTION_SAVE_CUSTOM   0x00000080  // -S --Save
...
# define ACTION_BIT17         0x00010000
# define ACTION_BIT18         0x00020000
# define ACTION_BIT19         0x00040000
# define ACTION_BIT20         0x00080000
# define ACTION_BIT21         0x00100000
# define ACTION_BIT22         0x00200000
# define ACTION_BIT23         0x00400000
# define ACTION_BIT24         0x00800000
# define ACTION_BIT25         0x01000000
# define ACTION_BIT26         0x02000000
# define ACTION_BIT27         0x04000000
# define ACTION_BIT28         0x08000000
# define ACTION_BIT29         0x10000000
# define ACTION_BIT30         0x20000000
# define ACTION_BIT31         0x40000000
# define ACTION_BIT32         0x80000000
