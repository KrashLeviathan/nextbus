...
void action_agency_list(CommandLineAction *clAction,
			ConfigFile *configFile);
void action_agency_store(CommandLineAction *clAction,
			 ConfigFile *configFile);
void action_route_list(CommandLineAction *clAction,
		       ConfigFile *configFile);
void action_route_store(CommandLineAction *clAction,
			ConfigFile *configFile);
void action_schedule_list(CommandLineAction *clAction,
			  ConfigFile *configFile);
void action_predict_stop(CommandLineAction *clAction,
			 ConfigFile *configFile);
void action_predict_route(CommandLineAction *clAction,
			  ConfigFile *configFile);
